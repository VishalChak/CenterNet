...
class Debugger(object):
  ...
  # def write_video(self, pathOut = "/home/vishal/detection/CenterNet/data/output.avi"):
  #   out = cv2.VideoWriter('output.avi', -1, 20.0, (640,480))
  #   out = cv2.VideoWriter(pathOut,cv2.VideoWriter_fourcc(*'DIVX'), fps, size)
  #   for i in range(len(self.frame_arr)):
  #       # writing to a image array
  #       out.write(self.frame_arr[i])
  #   out.release()
  ...
  def add_coco_bbox(self, bbox, cat, conf=1, show_txt=True, img_id='default'):
    ...
    #self.frame_arr.append(self.imgs[img_id])
    #cv2.imwrite('/home/vishal/detection/CenterNet/data/out_4/' + str(count)+".jpeg", self.imgs[img_id])
    count = count+1
